...
function detectSimulationLimitations(simulation, errorCode, errorMessage, logs) {
    ...
    if (errorMessage) {
        ...
        if (errorLower.includes("already in use") ||
            errorLower.includes("already processed") ||
            errorLower.includes("duplicate")) {
            warnings.push("already-executed");
        }
        if (errorLower.includes("slot") ||
...
//# sourceMappingURL=simulationWarnings.js.map